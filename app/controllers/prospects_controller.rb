...
# Controllers for healthcare program
  ...
  # def entrust_lead_status
  # end

  # def entrust_lead_status_update
  #   if @prospect.update(prospect_params)
  #     flash[:success] = "Lead has been updated."
